...
Original file is located at
    https://colab.research.google.com/drive/1lVdGg4KhB2uj6kLvHBLya-ZYrm7IWP7g
"""

# resnet_encoder_unet_skeleton.py
import torchvision
...
class UNetWithResnet50Encoder(nn.Module):
    def __init__(self, n_classes=22):
        ...
        self.layer2 = nn.Sequential(
            ResidualBlock(64, 64, 256), # downsample=False, except last one
            ResidualBlock(256, 64, 256),
            ResidualBlock(256, 64, 256, downsample=True) # Code overlaps with previous assignments
        )
        self.layer3 = nn.Sequential(
            ResidualBlock(256, 128, 512), # downsample=False, except last one
